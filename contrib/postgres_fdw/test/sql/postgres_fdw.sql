...
-- 1) Those sql run in gpdb, and it connects to postgres database using postgres_fdw.
...
\! psql -p ${PG_PORT} contrib_regression -f test/sql/postgres_init.sql
-- ===================================================================
...
-- Test that trigger on remote table works as expected
 \! psql -p ${PG_PORT} contrib_regression -f test/sql/create_trigger.sql
